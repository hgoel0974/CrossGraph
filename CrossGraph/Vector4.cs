...
namespace CrossGraph.Math
{
    public struct Vector4 : IEquatable<Vector4>
    {
...
#if PSM
		public static implicit operator PssVector4(Vector4 v)
        {
            return new PssVector4(v.X, v.Y, v.Z, v.W);
        }
		
		public static implicit operator Vector4(PssVector4 v)
        {
        ...
        public static implicit operator Vector4(OpenTK.Vector4 v)
        {
            return new Vector4(v.X, v.Y, v.Z, v.W);
        }
#endif
