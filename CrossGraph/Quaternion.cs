...
#elif OPENTK
        public static implicit operator OpenTK.Quaternion(Quaternion a)
        {
            return new OpenTK.Quaternion(a.X, a.Y, a.Z, a.W);
        }

        public static implicit operator Quaternion(OpenTK.Quaternion a)
        {
            return new Quaternion(a.X, a.Y, a.Z, a.W);
        }
#endif
